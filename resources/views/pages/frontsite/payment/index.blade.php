...
@section('content')
    ...
    <div class="min-h-screen">
        <div
          class="max-w-7xl grid lg:grid-cols-12 mx-auto pt-14 lg:pt-20 pb-20 lg:pb-28 lg:divide-x px-4 lg:px-16"
        >
          <!-- Detail Payment -->
            ...
            <div class="flex flex-wrap items-center space-x-5">
              <div class="flex-shrink-0">
                <img
                  ...
                  class="w-20 h-20 rounded-full bg-center object-cover object-top"
                  alt="Doctor 1"
                />
              </div>
